...
<?php 
$ApiEndpoint = "http://localhost:3030/enderecos/13";
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($address)) {
                                            foreach ($address as $row) {
                                                ...
                                                <a href='../../Controllers/AddressController.php?action=U&Id=" . $row->Id . "' class='btn btn-info' title='Editar' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                                                <a href='../../Controllers/AddressController.php?action=D&Id=" . $row->Id . "' onclick='return texto()' class='btn btn-danger' title='Excluir' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                                                </td>
